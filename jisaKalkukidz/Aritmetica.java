...
public class Aritmetica extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent ae) {
		...
		else if ((o == btnSuma) || (o == btnResta) || (o == btnMultiplicacion) || (o == btnDivision))
		{
			...
			// mostramos en lblOperacion el numero1 y la operacion a realizar
			
			lblOperacion.setText(numero1 + operacion);
		...
		// acciones a realizar si el boton pulsado es el boton igual
		else if (o== btnIgual)
		{
		...
		// acciones a realizar si el boton pulsado es un boton de punto
		else if(o == btnPunto)
		{
			int longitud;
			int posicion;
			...
			hayPunto = false;
			longitud = loQueHayEnPantalla.length();
			posicion = 0;
			...
			while ((posicion < longitud) && (hayPunto == false))
			{
				...
				if (loQueHayEnPantalla.substring(posicion, posicion + 1).equals("."))
				{
		...
		// acciones a realizar si el boton pulsado es el de atras
		else if(o == btnAtras)
		{
			// obtenemos la longitud de lo que hay en pantalla
			int longitud = loQueHayEnPantalla.length();
			...
			if ( longitud > 1) // si hay algo en el String
			{
				...
				loQueHayEnPantalla = loQueHayEnPantalla.substring(0, longitud -1);
				
				// mostramos en la pantalla resultado el resultado anterior (el string menos el ultimo caracter)
				lblResultado.setText(loQueHayEnPantalla);
		...
		// acciones a realizar si el boton pulsado es el de borrar
		else if (o == btnBorrar)
		{

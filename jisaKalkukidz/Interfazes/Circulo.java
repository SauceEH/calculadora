...
public class Circulo extends JFrame implements ActionListener {
	...
	private double pi= 3.141592; //hacemos esto para que la aplicacion obtenga el numero pi desde el principio
	private String numero=""; //Al poner este valor el programa no asignara un valor nulo cuando seleccionemos el boton de borrar
	private double area;
	private double perimetro;
	private double radio;
	private String cadenarea; //Para poder hacer la formula del area del circulo
	private String cadenaperimetro; //Para poder hacer la formula del perimetro del circulo
	...
	public Circulo() {
		...
		btnIgual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae)
			{
				...
				cadenarea = Double.toString(area);
				cadenaperimetro = Double.toString(perimetro);
		...
		btnPunto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String loQueHayEnResultado = lblPantalla.getText();
				int longitud;
				int posicion;
				boolean hayPunto;

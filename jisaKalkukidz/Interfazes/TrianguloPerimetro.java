...
public class TrianguloPerimetro extends JFrame implements ActionListener {
	...
	private String cadenaperimetro;
	...
	public TrianguloPerimetro() {
		...
		lblResultado.setFont(new Font("Calibri", Font.BOLD, 21));
		lblResultado.setBounds(80, 461, 100, 24);
	...
	public void actionPerformed(ActionEvent ae) {
	   ...
	   loQueHayEnPantalla = lblMensaje.getText();
	   
	   lblMensaje.setText(lblMensaje.getText() + texto);
